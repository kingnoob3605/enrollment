...
const AdminDashboard = () => {
  ...
  // Ensure data is preserved across component remounts
  useEffect(() => {
    // In a real app, this would fetch data from an API
    // For now, we'll use our static data

    // You could load from localStorage here if needed
    ...
    return (
      <div className="admin-dashboard-home">
        ...
        <div className="students-by-section">
          <h3 className="students-by-section-header">Students by Section</h3>
